...
public class Listado_de_Aplicaciones_Estudiante extends javax.swing.JFrame {


    
     int pase=0;
    public Listado_de_Aplicaciones_Estudiante() {
        initComponents();
    ...
    private void Boton_autoAprendizajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Boton_autoAprendizajeActionPerformed
            ListaArchivos_Subidos_Estudiante principal= new ListaArchivos_Subidos_Estudiante();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listado_de_Aplicaciones_Estudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Listado_de_Aplicaciones_Estudiante().setVisible(true);
            }
        });
    }
