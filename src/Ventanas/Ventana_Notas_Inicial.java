...
public class Ventana_Notas_Inicial extends javax.swing.JFrame {
 private TextAutoCompleter ac_DniEstudiante;
  
    public Ventana_Notas_Inicial() {
        initComponents();
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Boton_guardarNotas, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void Boton_guardarNotasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Boton_guardarNotasActionPerformed
        ...
        }else
        {
         try 
            {
            Connection cn=Conexion.Conectar();
            PreparedStatement pst=cn.prepareStatement("update "+tablaConsulta+" set 1B_Personal_Social=?,1B_Comunicacion=?,1B_Matematica=?,1B_Ciencia_Ambiente=?,"
                    + "2B_Personal_Social=?,  2B_Comunicacion=?,2B_Matematica=?,2B_Ciencia_Ambiente=?,"
                    + "3B_Personal_Social=?,  3B_Comunicacion=?,3B_Matematica=?,3B_Ciencia_Ambiente=?,"
                    + "4B_Personal_Social=?,  4B_Comunicacion=?,4B_Matematica=?,4B_Ciencia_Ambiente=? where Dni_est='"+dni+"'and FechaRegistro  like"+'"'+año+'"');
            pst.setString(1,(TXT_1B_Personal_Social.getText().trim()));  
            pst.setString(2,(TXT_1B_Comunicación.getText().trim() ));
            pst.setString(3,(TXT_1B_Matemática.getText().trim() ));
            pst.setString(4,(TXT_1B_Ciencia_y_Tecnología.getText().trim()));
            
            pst.setString(5,(TXT_2B_Personal_Social1.getText().trim()));  
            pst.setString(6,(TXT_2B_Comunicación1.getText().trim() ));
            pst.setString(7,(TXT_2B_Matemática1.getText().trim() ));
            pst.setString(8,(TXT_2B_Ciencia_y_Tecnología1.getText().trim()));
            
            pst.setString(9,(TXT_3B_Personal_Social2.getText().trim()));  
            pst.setString(10,(TXT_3B_Comunicación2.getText().trim() ));
            pst.setString(11,(TXT_3B_Matemática2.getText().trim() ));
            pst.setString(12,(TXT_3B_Ciencia_y_Tecnología2.getText().trim()));   
            
            pst.setString(13,(TXT_4B_Personal_Social3.getText().trim()));  
            pst.setString(14,(TXT_4B_Comunicación3.getText().trim() ));
            pst.setString(15,(TXT_4B_Matemática3.getText().trim() ));
            pst.setString(16,(TXT_4B_Ciencia_y_Tecnología3.getText().trim()));
            pst.executeUpdate();
            cn.close();
  ...
  // ingrese valores de 0 a 20
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Notas_Inicial().setVisible(true);
            }
        });
    }
