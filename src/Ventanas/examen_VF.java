...
public class examen_VF extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Registrar Examen Verdadero / Falso ");
    ...
    Respuesta5=txt_RESP5.getText().trim();
        ...
        {  // pregusntar si se desea guardar la actualizacion
            ...
            try
            {
             ...
             PreparedStatement pst1= cn1.prepareStatement("select Codigo from tabla_examenes_vf where Codigo='"+Codigo+"'");
        ...
        if(mensaje==JOptionPane.YES_OPTION)
        {
                     try
                     {
                      ...
                      // preguntar si desea generar un nuevo registro
                        ...
                        {
                            JOptionPane.showMessageDialog(null, "Error al registrar nuevo examen V/F \n contacte al Administrador","",JOptionPane.WARNING_MESSAGE);
                            System.err.println("error al registrar examen nuevo de V/F: "+e);
                        }
                    }else
