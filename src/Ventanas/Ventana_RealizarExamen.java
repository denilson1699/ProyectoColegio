...
public class Ventana_RealizarExamen extends javax.swing.JFrame {
    public int anchoEmviar, altoEnviar; 
    public Ventana_RealizarExamen() {
        initComponents();
        this.setExtendedState(MAXIMIZED_BOTH);
        
        anchoEmviar= jDesktopPane1.getSize().width;
        altoEnviar= jDesktopPane1.getSize().height;
    }
    ...
    private void initComponents() {
        ...
        label_tituloAsistencia_Estudiates.setText("Realizar Nuevo Examen /Practica");
    ...
    private void RB_EXAMEN_VFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RB_EXAMEN_VFActionPerformed
        examen_VF mensajero= new examen_VF();
    ...
    private void rb_examenResp_LibresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rb_examenResp_LibresActionPerformed
         ...
         examen_RespustaLibre mensajero= new examen_RespustaLibre();
        jDesktopPane1.add(mensajero);
        mensajero.setVisible(true);
    ...
    private void RB_EXAMEN_AlternativasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RB_EXAMEN_AlternativasActionPerformed
         examen_Alternativas mensajero= new examen_Alternativas();
        jDesktopPane1.add(mensajero);
        mensajero.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_RealizarExamen().setVisible(true);
            }
        });
    }
