...
public class Ventana_Notas_Secundaria extends javax.swing.JFrame {
 private TextAutoCompleter ac_DniEstudiante;
  
    public Ventana_Notas_Secundaria() {
        initComponents();
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(Boton_guardarNotas, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void Boton_guardarNotasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Boton_guardarNotasActionPerformed
        ...
        }else
        {
         try 
            {
            Connection cn=Conexion.Conectar();
            PreparedStatement pst=cn.prepareStatement("update "+tablaConsulta+" set "
                    + "1B_Matematica=?, 1B_Comunicacion=?, 1B_Ingles=?,1B_Arte=?,1B_HGE=?,1B_FCC=?,1B_PFRH=?,1B_Educacion_Fisica=?,1B_Educación_Religiosa=?,1B_CTA=?,1B_EPT=?,"
                    + "2B_Matematica=?, 2B_Comunicacion=?, 2B_Ingles=?,2B_Arte=?,2B_HGE=?,2B_FCC=?,2B_PFRH=?,2B_Educacion_Fisica=?,2B_Educación_Religiosa=?,2B_CTA=?,2B_EPT=?,"
                    + "3B_Matematica=?, 3B_Comunicacion=?, 3B_Ingles=?,3B_Arte=?,3B_HGE=?,3B_FCC=?,3B_PFRH=?,3B_Educacion_Fisica=?,3B_Educación_Religiosa=?,3B_CTA=?,3B_EPT=? where Dni_est='"+dni+"'and FechaRegistro  like"+'"'+año+'"');
            pst.setString(1,(TXT_1B_Matematica.getText().trim()));  
            pst.setString(2,(TXT_1B_Comunicacion.getText().trim()));
            pst.setString(3,(TXT_1B_ingles.getText().trim()) );
            pst.setString(4,(TXT_1B_Arte.getText().trim() ));
            pst.setString(5,(TXT_1B_HGE.getText().trim() ));
            pst.setString(6,(TXT_1B_FCC.getText().trim()));
            pst.setString(7,(TXT_1B_PFRH.getText().trim()));
            pst.setString(8,(TXT_1B_Educacíon_Fisica.getText().trim() ));
            pst.setString(9,(TXT_1B_Educacíon_Religiosa.getText().trim()));
            pst.setString(10,(TXT_1B_CTA.getText().trim()));
            pst.setString(11,(TXT_1B_EPT.getText().trim()));

            pst.setString(12,(TXT_1B_Matematica1.getText().trim()));  
            pst.setString(13,(TXT_1B_Comunicacion1.getText().trim()));
            pst.setString(14,(TXT_1B_ingles1.getText().trim()) );
            pst.setString(15,(TXT_1B_Arte1.getText().trim() ));
            pst.setString(16,(TXT_1B_HGE1.getText().trim() ));
            pst.setString(17,(TXT_1B_FCC1.getText().trim()));
            pst.setString(18,(TXT_1B_PFRH1.getText().trim()));
            pst.setString(19,(TXT_1B_Educacíon_Fisica1.getText().trim() ));
            pst.setString(20,(TXT_1B_Educacíon_Religiosa1.getText().trim()));
            pst.setString(21,(TXT_1B_CTA1.getText().trim()));
            pst.setString(22,(TXT_1B_EPT1.getText().trim()));

            pst.setString(23,(TXT_1B_Matematica2.getText().trim()));  
            pst.setString(24,(TXT_1B_Comunicacion2.getText().trim()));
            pst.setString(25,(TXT_1B_ingles2.getText().trim()) );
            pst.setString(26,(TXT_1B_Arte2.getText().trim() ));
            pst.setString(27,(TXT_1B_HGE2.getText().trim() ));
            pst.setString(28,(TXT_1B_FCC2.getText().trim()));
            pst.setString(29,(TXT_1B_PFRH2.getText().trim()));
            pst.setString(30,(TXT_1B_Educacíon_Fisica2.getText().trim() ));
            pst.setString(31,(TXT_1B_Educacíon_Religiosa2.getText().trim()));
            pst.setString(32,(TXT_1B_CTA2.getText().trim()));
            pst.setString(33,(TXT_1B_EPT2.getText().trim()));
  ...
  // ingrese valores de 0 a 20
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Notas_Secundaria().setVisible(true);
            }
        });
    }
