...
public class Ventana_Notas_Primaria_estudiante extends javax.swing.JFrame {
 private TextAutoCompleter ac_DniEstudiante;
  
    public Ventana_Notas_Primaria_estudiante() {
        initComponents();
  ...
  // ingrese valores de 0 a 20
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Notas_Primaria_estudiante().setVisible(true);
            }
        });
    }
